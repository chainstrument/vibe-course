  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-20">
      ...
      <div className="mb-16">
        ...
        <h1 className="text-4xl font-bold text-stone-900 dark:text-white leading-tight mb-6">
          Pourquoi Vibe Course existe
        </h1>
        <p className="text-stone-500 dark:text-zinc-400 text-lg leading-relaxed">
          Une plateforme d'apprentissage du vibecoding. Pas pour apprendre à coder —
          pour apprendre à <em className="text-stone-700 dark:text-zinc-200 not-italic font-medium">builder</em>.
        </p>
      </div>

      {/* Manifeste */}
      <div className="space-y-12 text-stone-600 dark:text-zinc-300 leading-relaxed">
        <section>
          <h2 className="text-xl font-semibold text-stone-900 dark:text-white mb-4">Le contexte</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-stone-900 dark:text-white mb-4">Ce qui a changé</h2>
          <p>
          ...
          <p className="mt-4">
            C'est ce qu'Andrej Karpathy a appelé le <strong className="text-stone-900 dark:text-white">vibecoding</strong> en 2025 :
            construire en collaborant avec l'IA, en faisant confiance au processus, en itérant.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-stone-900 dark:text-white mb-4">Ce qu'on croit</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-stone-900 dark:text-white mb-4">Ce que Vibe Course n'est pas</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-stone-900 dark:text-white mb-4">Comment c'est construit</h2>
          <p>
      ...
      {/* CTA */}
      <div className="mt-16 pt-10 border-t border-stone-200 dark:border-white/10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <Link
          href="/modules"
        ...
        <Link href="/exercices" className="text-sm text-stone-500 hover:text-stone-700 dark:hover:text-zinc-300 transition-colors">
          Voir les exercices
        </Link>
      </div>
    </div>
